...
DEFINES = ['NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_PACKET_H=1', 'HAVE_MPI=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1']
...
INCLUDES_MPI = ['/usr/local/include']
...
LINKFLAGS_MPI = ['-Wl,-rpath', '-Wl,/usr/local/lib', '-Wl,--enable-new-dtags']
...
NS3_EXECUTABLE_PATH = ['/home/wxz/simulation/build/src/emu', '/home/wxz/simulation/build/src/tap-bridge']
...
cfg_files = ['/home/wxz/simulation/build/ns3/config-store-config.h', '/home/wxz/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
...
define_key = ['HAVE_PACKET_H', 'HAVE_MPI', 'HAVE_SQLITE3', 'HAVE_IF_TUN_H']
